...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $res = $satmt->fetch();
    $ECode = $res[0];
    $query = "insert into grades (IDS, ECode, Grade, IDD) values ('$IDS', '$ECode', '$Grade', '$IDD')
        ...
        <div class="container">
            <div class="row justify-content-middle" style="margin-left: 397px;">
                <div class="col-md-6 mt-5">
                    <form action="AddNote.php?IDS=<?php echo $IDS; ?>&CourseCode=<?php echo $FilteredCCode; ?>" method="POST" class="appointment-form" style="margin-top: -568px;">
                        <div class="row">
