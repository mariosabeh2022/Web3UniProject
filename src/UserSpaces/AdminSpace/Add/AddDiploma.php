  ...
  <div class="container">
    <div class="row justify-content-middle" style="margin-left: 397px;">
      <div class="col-md-6 mt-5">
        <form action="AddNewDiploma.php" method="POST" class="appointment-form" style="margin-top: -568px;">
          <h3 class="mb-3">Add a new diploma</h3>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <input type="text" name="DiplomaCode" id="DiplomaCode" class="form-control" placeholder="Diploma Code" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
