  ...
  <div class="container">
    <div class="row justify-content-middle" style="margin-left: 397px;">
      <div class="col-md-6 mt-5">
        <form action="AddNewCourse.php" method="POST" class="appointment-form" style="margin-top: -568px;">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <input type="number" name="Credits" id="Credits" class="form-control" placeholder="Credits" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <select class="form-group" name="Diploma">
                  <?php
                  $query = "select Name from diploma";
            ...
            <div class="col-md-12">
              <div class="form-group">
                <select class="form-group" name="Doctor">
                  <?php
                  $query = "select FirstName,MiddleName,LastName from doctor";
                  $result = $PDO->prepare($query);
                  $result->execute();
                  while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    $FName = $row['FirstName'];
            ...
            <div class="col-md-12">
              <div class="form-group">
                <select class="form-group" name="CodeSemester">
                  <?php
                  $query = "select distinct(CodeSemester) from semester";
                  $result = $PDO->prepare($query);
                  $result->execute();
                  while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    $CodeSemester = $row['CodeSemester'];
                    echo "<option value='$CodeSemester'>$CodeSemester</option>";
                  }
                  ?>
                </select>
              </div>
            ...
            <div class="form-group">
              <input type="submit" value="Add" name="AddDiploma" id="submit" class="btn btn-primary py-3 px-4">
            </div>
          </div>
        </form>
      </div>
