      ...
      <div class="row">
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/gradhat.jpeg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Students informations</h3>
              <p><a href="Display/DisplayStudents.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/doctor.jpeg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Doctors informations</h3>
              <p><a href="Display/DisplayDoctors.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/admin.jpeg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Admins informations</h3>
              <p><a href="Display/DisplayAdmins.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="ftco-section ftco-services">
    <div class="container">
      <div class="row">
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/course.jpeg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Courses informations</h3>
              <p><a href="Display/DisplayCourses.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/diploma.jpeg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Diplomas informations</h3>
              <p><a href="Display/DisplayDiplomas.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
      </div>
