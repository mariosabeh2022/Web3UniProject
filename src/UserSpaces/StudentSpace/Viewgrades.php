        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="../StudentSpace/StudentSpace.php" class="nav-link">Home</a></li>
            ...
            <div class="navbar-header">
                <form class="row g-3" action="Viewgrades.php" method="POST">
                    <div class="col-12">
                        ...
                        <input type="submit" class="btn btn-primary" value="Filter by year" name="Filter1">
                </form>
                <br>
                <br>
                <a href="Viewgrades.php" class="btn btn-primary">Remove filter</a>
            </div>
            <br>
        </div>
    </nav>
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="border: 2px solid black">
            ...
            FROM
                ...
                exam
            WHERE
                course.CourseCode = exam.CourseCode AND
                course.IDD=doctor.IDD AND
                exam.ECode = grades.ECode AND
                ...
                ";
                        ...
                        while ($result2 = $statement2->fetch()) {
                            ...
                            echo "<td>" . $result2[1] . "</td>";
                            echo "<td>" . $result2[2] . "</td>";
                            echo "<td>" . $result2[3] . "</td>";
                            echo "<td>" . $result2[4] . "</td>";
                            echo "<td>" . $result2[5] . "</td>";
                            echo "<td>" . $result2[6] . "</td>";
                            echo "<td>" . $result2[7] . "</td>";
