        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            if (empty($_SESSION['Username']) && empty($_SESSION['Page'])) {
              ...
              echo "<li><a class='dropdown-item' href='../../HomePage/Homepage.php'>Home</a></li>";
      ...
      <div class="row">
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/coursesspic.jpg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Display Courses</h3>
              <p><a href="../StudentSpace/DisplayCourse.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 d-flex services align-self-stretch px-4">
          <div class="d-block services-wrap text-center">
            <div class="img" style="background-image: url(../../../assets/LogoFolder/gradespic.jpg);"></div>
            <div class="media-body py-4 px-3">
              <h3 class="heading">Grades</h3>
              <p><a href="../StudentSpace/Viewgrades.php" class="btn btn-primary">View</a></p>
            </div>
          </div>
        </div>
