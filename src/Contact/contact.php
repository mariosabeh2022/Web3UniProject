			...
			<div class="row no-gutters">
				<div class="col-md-12">
					<div id="map" class="map">
						<script>
							var map = L.map('map').setView([33.8938, 35.5018], 10);

							L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
								attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
							}).addTo(map);

							L.marker([34.0641747, 35.650751]).addTo(map)
								.bindPopup('ESU<br> Naher-Ibrahim')
								.openPopup();
						</script>
					</div>
				</div>
						...
						<div class="row no-gutters">
							<div class="col-lg-8 col-md-7 d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form action="contactForm.php" method="POST" id="contactForm" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" class="form-control" name="email" id="email" placeholder="Email" value="ESU.university.lb@gmail.com" readonly>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
