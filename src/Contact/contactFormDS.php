...
if (isset($_POST['SendMSGbtn'])) {
    ...
    $query = "select Email from doctor where IDD = '$IDD'";
    ...
    if ($result) {
        ...
        echo "<script>alert('No email found for the doctor.'); history.back();</script>";
        exit();
    }
    ...
    try {
        ...
        header("Refresh:0; url=../UserSpaces/DoctorSpace/doctorSpace.php");
        exit();
    } catch (Exception $e) {
