...
<head>
  ...
  <script src="VerifyReEnteredPassword.js"></script>
</head>
  ...
  <div class="container">
    <div class="row justify-content-middle" style="margin-left: 397px;">
      <div class="col-md-6 mt-5">
        <form action="ResetPassword.php" method="POST" class="appointment-form" style="margin-top: -568px;">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <input type="password" name="Password1" id="password" class="form-control" placeholder="Password" onkeyup="verify()" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <input type="password" name="Password2" id="password2" class="form-control" placeholder="Re-enter Password" onkeyup="verify()" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <span name="ValidPass" id="ValidPass"></span>
                <input type="submit" value="Reset" name="Login" class="btn btn-primary py-3 px-4" >
              </div>
            </div>
          </div>
      </div>
